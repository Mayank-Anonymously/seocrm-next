...
const UploadDocument = (props: any) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      selector: (row: any) =>
        row.expiryDate !== ""
          ? moment(row.expiryDate).format("MM-DD-YYYY")
          : "",
      sortable: true,
    },
    {
  ...
  for (let index = 0; index < docs.length; index++) {
    ...
    const parse_url =
      element.docStructure !== undefined &&
      element.docStructure !== null &&
      JSON.parse(element.docStructure);
    rows.push({
      id: element.id,
      type: element.type,
      employeeName: element.employee?.name,
      downloadUrl: parse_url["@microsoft.graph.downloadUrl"],
      expiryDate: element.expiryDate === null ? "" : element.expiryDate,
          ...
          <form onSubmit={formik.handleSubmit}>
            <Row>
              <Col className="mt-3" md={5} mt={2}>
                ...
                <Autocomplete
                  ...
                  onSelect={(option: any) => {
                    ...
                    if (option.target.value === "others") {
                      formik.setFieldValue("others", true);
                    }
                  }}
                  renderInput={(params) => (
              ...
              {formik.values.docType === "others" ? (
                <Col className="mt-3" md={5} mt={2}>
                  <FormLabel for="Document Name" labelname="Doc Name" />
              ...
              <Col className="mt-3" md={5}>
                <FormLabel for="Document Description" labelname="Description" />
              ...
              <Col className="mt-3" md={5}>
                <div>
                  <label
                    ...
                    htmlFor="showHideCheckbox"
                  >
                    Is expiry Applicable ?
                  </label>
                  <input
                    type="checkbox"
                    id="showHideCheckbox"
                ...
                {checked && ( // Render the following Col only if checked is true
                  <Col className="mt-3">
                    <FormLabel htmlFor="ExpiryDate" labelname="Expiry Date" />
                    <input
                      type="date"
                      id="expiryDate"
                      className="form-control"
