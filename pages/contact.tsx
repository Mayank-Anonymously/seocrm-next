...
const Contacts = () => {
  ...
  return (
    <React.Fragment>
      <Head>
        <title>Contact | Lavya -Admin </title>
      </Head>
                    ...
                    <ul className="list-unstyled contact-menu-list">
                      <li>
                        ...
                        >
                          ...
                          <span className="menu-list-link" data-tab="all">
                            All Contacts
                          </span>
                        </Link>
                      </li>
                    ...
                    <ul className="list-unstyled contact-menu-list">
                      <li>
                        ...
                        >
                          ...
                          <span className="menu-list-link" data-label="Friends">
                            Friends
                          </span>
                        </Link>
                      </li>
                      <li>
                        ...
                        >
                          ...
                          <span className="menu-list-link" data-label="Family">
                            Family
                          </span>
                        </Link>
                      </li>
