...
import logolight from "@assets/images/logob.png";
          ...
          <div className="navbar-header">
              ...
              <div className="navbar-brand-box horizontal-logo">
                <Link href="/dashboard" className="logo logo-dark">
                  ...
                  <span className="logo-lg">
                    <Image src={logodark} alt="" height="40" priority={true} />
                  </span>
                </Link>
                ...
                <Link href="/dashboard" className="logo logo-light">
                  ...
                  <span className="logo-lg">
                    <Image src={logolight} alt="" height="40" />
                  </span>
                </Link>
              </div>
            ...
            <div className="d-flex align-items-center">
              ...
              <Dropdown className="topbar-head-dropdown ms-1 header-item">
                ...
                <Dropdown.Menu
                  className="p-2 dropdown-menu-end"
                  id="light-dark-mode"
                >
                  <Dropdown.Item
                    href="#"
                  ...
                  >
                    <i className="bi bi-sun align-middle me-2"></i> Defualt
                    (light mode)
                  </Dropdown.Item>
                  <Dropdown.Item
                    href="#"
