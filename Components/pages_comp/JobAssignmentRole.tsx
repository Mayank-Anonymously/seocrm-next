...
const JobAssignmentRole = (props: any) => {
  ...
  const [amIdRecuiter, setAmIdRecuiter] = useState<any>([]);
  ...
  const handleCheckuser = () => {
    ...
    var recruiter = recruiterData.filter(
      (item: any) => item.managerId === parseUser.id
    );
    setAmIdRecuiter(recruiter);
    setTeamLead(tel);
  };
                      ...
                      >
                        ...
                        <select
                          ...
                          onChange={(e) => {
                            ...
                            dispatch(fetchUserByManagerId(e.target.value));
                          }}
