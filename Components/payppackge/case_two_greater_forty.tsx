...
const Case_two = ({
  ...
  const taxablehourRate = () => {
    var taxablehour: any;
    taxablehour = taxable() / gHours;
    return taxablehour;
  };

  const nontaxablehourRate = () => {
    var nontaxablehour: any;
    nontaxablehour = nontaxable() / gHours;
  ...
  /* Gross Weekly= (Pay Rates*40) + (OT Rates*8) */
  const grossgreaterforty = () => {
    var grossforty: any;
    var greaterforty: any = gHours - 40;
    grossforty = calculatePayRate() * 40 + otrates() * greaterforty;
    return grossforty;
  };
